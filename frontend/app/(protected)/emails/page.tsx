...
import { Loader2, Send, ArrowUpRight, ArrowDownLeft, Clock, Search, Mail, Plus, RefreshCw, Trash2 } from 'lucide-react';
import { toast } from 'sonner';
import { getEmailSent, getEmailInbox, getEmailAccounts, deleteEmailMessage } from '@/app/actions-email';
...
export default function EmailInboxPage() {
    ...
    const [viewTab, setViewTab] = useState<'inbox' | 'sent'>('sent');
    ...
    const displayMessages = viewTab === 'sent' ? sentMessages : messages;
                ...
                <div className="flex items-center justify-between mb-6 shrink-0">
                    <div>
                        ...
                        <p className="text-sm text-slate-500 mt-1">
                            {viewTab === 'sent' ? 'E-mails enviados pelo CRM.' : 'Caixa de entrada sincronizada.'}
                        </p>
                    </div>
                        ...
                        <div className="flex-1 overflow-y-auto divide-y divide-slate-100">
                            {loading ? (
                                ...
                                <div className="flex flex-col items-center justify-center py-20 text-center">
                                    ...
                                    <button onClick={() => setShowComposer(true)} className="mt-4 text-sm text-blue-600 font-semibold hover:text-blue-800">
