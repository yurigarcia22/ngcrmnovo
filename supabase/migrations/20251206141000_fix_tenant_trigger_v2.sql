-- Função para lidar com novos usuários - VERSÃO CORRIGIDA (SEM COLUNA ROLE)
...
BEGIN
  ...
  IF invited_tenant_id IS NOT NULL THEN
    ...
    -- REMOVIDO: coluna 'role', pois ela aparentemente não existe na tabela profiles deste projeto
